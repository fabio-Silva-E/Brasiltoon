...
<html lang="pt-br">
  ...
  height: auto;
        ...
        padding: 20px; /* Adapte conforme necessário para espaçamento */
   padding-top: 75%;
      z-index: 1;
        margin-right: 10px; /* Ajuste o valor para aproximar mais os botões */
    ...
    <body>
        <div class="scrollable">
            ...
            <a href="biblioteca.jsp">voltar</a>
              <jsp:include page="favoritar.jsp" /> 
