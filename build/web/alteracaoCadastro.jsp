    ...
    <div class="container mt-5">
        ...
        <form name="frm" method="post" action="AtualizarUsuarioServlet" onsubmit="return confirmarAlteracao()">
            ...
            <div class="mb-3">
                ...
                <input value="${Usuario.tel}" type="tel" id="telefone" name="telefone" pattern="[0-9]*" inputmode="numeric" class="form-control">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input value="${Usuario.senha}" type="password" id="senha" name="senha" class="form-control">
            </div>
            <div class="mb-3">
                <label for="Confirmarsenha" class="form-label">Confirmar Senha</label>
                <input type="password" id="Confirmarsenha" name="Confirmarsenha" value="${Usuario.senha}" class="form-control">
            </div>
            <button type="submit" class="btn btn-primary">Alterar Cadastro</button>
            <a class="btn btn-secondary" href="HomeController?operacao=1&id=${Usuario.id}">Voltar</a>
        </form>
    </div>
</body>
