...
function atualizarTabela(data) {
    ...
    'text-align': 'center' // Adicionado para alinhar horizontalmente
        ...
        const imagemLink = $('<a>').attr('href', 'HistoriasServlet?operacao=4&id=' + historia.id+'&idhc='+historia.capa);
        ...
        const autorRow = $('<tr>');
        const autorCell = $('<td>');
        const autorLink = $('<a>').attr('href', 'HistoriasServlet?operacao=3&id=' + historia.autorid)
        .text('Autor')
        .css('color', 'white');
