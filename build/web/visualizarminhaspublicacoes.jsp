...
<html lang="pt-br">
  ...
  height: auto;
   ...
   padding-top: 75%;
      ...
      a.destacado {
  color:#4B0082		; /* Cor do texto destacado (pode ajustar a cor conforme necessário) */
  font-size: 20px; /* Tamanho da fonte */
  font-weight: bold; /* Negrito */
  text-decoration: none; /* Remover sublinhado padrão */
  transition: color 0.3s ease-in-out; /* Adicionar transição de cor para suavizar a alteração */
}

a.destacado:hover {
  color: blue; /* Cor do texto destacado ao passar o mouse (pode ajustar a cor conforme necessário) */
}
/* Adicione outras regras de estilo conforme necessário */
    ...
    <body>
        <div class="scrollable">
           ...
           <a class="destacado" href="minhasPublicacoes.jsp">voltar</a>
                
                 <jsp:include page="capitulos.jsp" />  
                 <jsp:include page="solicitarAlteracao.jsp" /> 
                     </div>
